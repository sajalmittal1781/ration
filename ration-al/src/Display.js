...
const Display = () => {
  return (
    <>
      ...
      <div class="  float-right p-7 max-w-sm ml-10 mt-8 md:mt-36 mr-10 md:mr-20 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
